...
#------------------------------------------------------------------------------------------------------------
N = 6									# Number of samples to take as training set
rootDir = os.getcwd()					# The root directory of the dataset
...
fileList = sorted(os.listdir('C:\\Users\\Rehan\\PycharmProjects\\pythonProject2\\dslr_images'))
dirName = 'C:\\Users\\Rehan\\PycharmProjects\\pythonProject2\\dslr_images'
#------------------------------------------------------------------------------------------------------------
